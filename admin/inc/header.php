...
<head>
    ...
    <title>Vacbook - Administration</title>

    <!-- Custom fonts for this template-->
    <link href="../admin/startbootstrap-sb-admin-2-gh-pages/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Vacbook <br>Administration</br></div>
            </a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <!-- <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <!-- Dropdown - Alerts -->
                            <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animatedgrow-in"
                            ...
                            <!-- <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../admin/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_1.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../admin/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_2.svg"
                                            alt="">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="../admin/startbootstrap-sb-admin-2-gh-pages/img/undraw_profile_3.svg"
                                            alt="">
